...
public class JU_DSLStoreSignupsAndUpgrades extends TestNgIntegration {
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_VZE_Saver0768_CC_Signup() {
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_VZE_Pro3000_LEC_Signup() {
		service = "DSL_VZE_Pro";
		paytype = "LEC";
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_VZE_Ultra7100_CC_Signup() {
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_VZE_SpeedSaver1500_LEC_Signup() {
	...
	@Test(groups = { "JUDSLSignup" })
	public void JU_Dsl_VZW_Saver0768_LEC_Signup() {
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_VZW_Pro3000_CC_Signup() {
		service = "DSL_VZW_Pro";
		paytype = "CC";
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_VZW_Ultra7100_LEC_Signup() {
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_VZW_SpeedSaver1500_CC_Signup() {
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_CQW_SpeedSaver1500_CC_Signup() {
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_CQW_Pro3000_LEC_Signup() {
		service = "DSL_CQW_Pro";
		paytype = "LEC";
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_CQW_Ultra6000_CC_Signup() {
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_ATTS_SpeedSaver1500_LEC_Signup() {
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_ATTS_Pro3000_CC_Signup() {
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_ATTS_Ultra6000_LEC_Signup() {
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_SonicTas_SpeedSaver1500_CC_Signup() {
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_SonicTas_Pro3000_LEC_Signup() {
	...
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_SonicTas_Ultra6000_CC_Signup() {
...
/*	
	@Test(groups = { "JUDSLSignups" })
	public void JU_Dsl_BLS_Pro3000_CC_Signup() {
		service = "DSL_BLS_Pro";
		paytype = "CC";
